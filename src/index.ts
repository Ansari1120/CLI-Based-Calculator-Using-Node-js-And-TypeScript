...
await welcome();
await askName();
let want_to_Continue: Boolean | undefined;
do {
  ...
  const handleAnswer = async (
    ...
    switch (choose_operations) {
      case "Addition":
        ...
        spinner.success({
          text: `\nThe Result of Addition is : ${chalk.bold.bgBlueBright(
            answer
          )}`,
        });
        break;
      case "Substraction":
        ...
        spinner.success({
          text: `\nThe Result of Substraction is : ${chalk.bold.bgBlueBright(
            answer
          )}`,
        });
        break;
      case "Division":
        ...
        spinner.success({
          text: `\nThe Result of Division is : ${chalk.bold.bgBlueBright(
            answer
          )}`,
        });
        break;
      case "Multiplication":
        ...
        spinner.success({
          text: `\nThe Result of Multiplication is : ${chalk.bold.bgBlueBright(
            answer
          )}`,
        });
        break;
