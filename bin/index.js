...
function Choices(choice1) {
    switch (choice1) {
        case 1:
            console.log("\nThe Result of Addition is : ".concat(calculator.add(num1, num2)));
            break;
        case 2:
            console.log("\nThe Result of Substraction is : ".concat(calculator.sub(num1, num2)));
            break;
        case 3:
            console.log("\nThe Result of Division is : ".concat(calculator.division(num1, num2)));
            break;
        case 4:
            console.log("\nThe Result of Multiplication is : ".concat(calculator.Multiplication(num1, num2)));
            break;
        default:
